...
public class GeoDataFactory
{
    ...
    public IEnumerable<PlacedItem> Create( object source )
    {
    ...
    private void SetLocation( PlacedItem item )
    {
        ...
        //( (IPlacedItemInternal) item ).Initialize( latitude, longitude, true );
    }
}
