...
public class CredentialsFactory
{
    ...
    public ICredentials? this[ string projName, bool initializeFromConfig ]
    {
        get
        {
            ...
            var configSection = _config.GetSection($"Credentials:{projName}");
    ...
    public ICredentials? this[Type projType, bool initializeFromConfig]
    {
        get
        {
            ...
            var configSection = _config.GetSection( $"Credentials:{kvp.Key}" );
